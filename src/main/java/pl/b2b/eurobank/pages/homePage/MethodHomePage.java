...
public class MethodHomePage {
    ...
    @FindBy(xpath = DataHomePaage.OSZCZEDNOSCI)
    private WebElement oszczednosci;
    ...
    public void clickOszczednosci() {
        wait.until(ExpectedConditions.elementToBeClickable(oszczednosci));
        oszczednosci.click();
    }
